            ...
            <div class="row">
                <div class="col-6">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="nama_mitra" aria-describedby="emailHelp" name="nama_mitra">
                    </div>
            ...
            <div class="row">
                ...
                <div class="col-3">
                    <div class="mb-3">
                        ...
                        <input type="number" class="form-control" id="stok" aria-describedby="emailHelp" name="stok">
                    </div>
                </div>
                <div class="col-3">
                    <div class="mb-3">
                ...
                <div class="col-3">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="pemilik" aria-describedby="emailHelp" name="pemilik">
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-3">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="no_hp" aria-describedby="emailHelp" name="no_hp">
                    </div>
                </div>
                <div class="col-3">
                    <div class="mb-3">
                        <label for="kontrak" class="form-label">Kontrak Kerja Sama</label>
                        <input type="number" class="form-control" id="kontrak" aria-describedby="emailHelp" name="kontrak">
                    </div>     
                </div>
                <div class="col-3">
                    <div class="mb-3">
                        <label for="tgl_kerjasama" class="form-label">Tanggal Kerja Sama</label>
                        <input type="date" class="form-control" id="tgl_kerjasama" aria-describedby="emailHelp" name="tgl_kerjasama">
                    </div>
                </div>
                <div class="col-3">
                    <div class="mb-3">
