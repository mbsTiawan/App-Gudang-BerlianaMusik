                ...
                <div class="white_card_header">
                    <div class="box_header m-0">
                        <div class="main-title"">
                                        <h3 class=" m-0"">Tambah Data Barang</h3>
                        </div>
                    </div>
                </div>

                <div class="white_card_body">
                    <form action="/BarangGudang/save" method="post">
                        <div class="row">
                            <div class="col-4">
                                <div class="mb-3">
                                    <label for="nama_brg" class="form-label">Nama Barang</label>
                                    <input type="text" class="form-control" id="nama_brg" aria-describedby="emailHelp" name="nama_brg">
                                </div>
                            </div>
                            <div class="col-4">
                                <div class="mb-3">
                        ...
                        <div class="row">
                            ...
                            <div class="col-4">
                                <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control" id="stok_pinjam" aria-describedby="emailHelp" name="stok_pinjam"  readonly>
                                </div>
                            </div>
                            <div class="col-4">
                                <div class="mb-3">
